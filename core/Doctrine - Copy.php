...
//require_once __DIR__.'/../core/Exception/ErrorsHandler.php';
class Doctrine
{
    public $con;
    public $table;
    ...
    public function paginate($limit){
        ...
        if($current_count == 0){
            ...
            $last_page = ceil(($total->count/$limit)+$limit);
            $last_page_url = url().'?page='.ceil(($total->count/$limit)+$limit);
        ...
        $pagination['first_page_url']= url().'?page=1';
